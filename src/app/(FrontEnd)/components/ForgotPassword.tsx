...
const ForgotPassword = ({isModel = false, width="", height=""}) => {
        ...
        if (!emailRegex.test(email)) {
            ...
            if (!passwordRegex.test(password)) {
                ...
                if (!nameRegex.test(firstname) || !nameRegex.test(lastname)) {
                    ...
                    axios.post('/api/v0.1/auth/forgot-password', {
                        firstName : firstname,
                        lastName : lastname,
                        email : email,
    ...
    return (
      <div className='LoginHolder'>
            <div className={`bg-black/40 border-4 border-[var(--maincolor)]`} style={{width: width, height: height}}>
                ...
                <div className='title flex justify-center font-bold my-2 text-[var(--maincolor)]'> Forgot Password </div>
